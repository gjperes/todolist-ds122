<?php 
    require('src/login_validation.php');
?>
...
<head>
    ...
    <title>Login - To Do Online List</title>
...
<body class="text-center">
  ...
  <div class="form-signin">
    <header>
      <img class="mb-4" src="images/person-badge.svg" alt="Logo de login" width="72" height="56">
    ...
    <main>
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="form-signin" enctype="multipart/form-data">
        <fieldset class="form-floating">
          ...
          <!--TODO: Implementar um div e span para inserir mensagem/alerta de erro da validação front-end-->
  ...
  <script src="src/login_validation.js"></script>
</body>
</html>